 ...
 * Copied from lib/prompt.ts for Convex action bundling.
 */
...
const STYLE_DESCRIPTORS: Record<ImageStyle, string> = {
  "gothic-clay":
    "surrealistic Gothic clay sculpture style, dark cathedral atmosphere, intricate clay textures, dramatic volumetric lighting",
  cinematic:
    "cinematic photography, dramatic golden-hour lighting, anamorphic lens flare, shallow depth of field, 35mm film grain, hyper-realistic",
  sketch:
    "detailed pencil and ink sketch, fine cross-hatching, expressive line art, monochrome with soft sepia wash, hand-drawn texture",
  "mystic-fight":
    "dynamic celestial battle scene, divine energy beams, glowing sacred auras, warriors of light, explosive spiritual composition",
  surreal:
    "Salvador Dali-inspired surrealism, dreamlike impossible landscape, melting sacred architecture, vivid otherworldly colors, metaphysical atmosphere",
  "oil-painting":
    "classical oil painting, impasto brushwork, rich warm Rembrandt palette, chiaroscuro dramatic lighting, old masters museum quality",
};
